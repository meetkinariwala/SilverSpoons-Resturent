        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="staffinsert mt-2">
                    ...
                    <input type="text" class="inputform" name="sname" placeholder="Enter here" value="{{$staff->fullname}}">
                    ...
                    <input type="text" class="inputform" name="adhaar" placeholder="Enter here" value="{{$staff->adharno}}">
                    <span class="text-danger">
                        @error('adhaar')
                            {{ $message }}
                        @enderror
                    ...
                    <input type="text" class="inputform" name="address" placeholder="Enter here" value="{{$staff->address}}">
                    <span class="text-danger">
                        @error('address')
                            {{ $message }}
                        @enderror
                    ...
                    <input type="text" class="inputform" name="phno" placeholder="Enter here" value="{{$staff->phone}}">
                    <span class="text-danger">
                        @error('phno')
                            {{ $message }}
                        @enderror
                    ...
                    <input type="text" class="inputform" name="email" placeholder="Enter here" value="{{$staff->email}}">
                    <span class="text-danger">
                        @error('email')
                            {{ $message }}
                        @enderror
